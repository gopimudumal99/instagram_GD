...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // 2) get the post ID for they newly created post
    ...
    <Transition.Root show={open} as="div">
      ...
      sm:block sm:p-0 "
        >
          ...
          >
            <div
              className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 text-left overflow-hidden shadow-xl 
            ...
            >
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
                    className="w-full object-contain h-[230px] cursor-pointer"
